...
| **Engenharia de Contexto e Logica Fisica** | Um script que integra dois sistemas lógicos desenvolvidos em Python: uma ferramenta de análise de indicadores ambientais urbanos e um simulador de navegação espacial para protocolos de evacuação. | [Ver Projeto]( |
|  | |  |
