...
| **Sistema de Modularização** |Modularização é dividir um sistema complexo em peças menores e independentes que se encaixam para facilitar a manutenção e o reuso.| [Ver Projeto]() |caixa-e-troco) | 
